    ...
    for (x, y, w, h) in faces:
        ...
        if eye_avg_ratio < eye_ratio_threshold:
            ...
            if sleep_frames >= max_sleep_frames:
                ...
                cv2.drawContours(frame, [left_eye_bound], -1, (0, 0, 255), 1)
                cv2.drawContours(frame, [right_eye_bound], -1, (0, 0, 255), 1)
                # Ve dong chu canh bao
                cv2.putText(frame, "Dang nham mat", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
